...
(function(l) {
    function t(b, f) {
        ...
        for (c = 0; c < h.length; c++)
            k = h[c], !g && k + "Transform" in d && (g = k), k = k.toLowerCase(), window.requestAnimationFrame || (window.requestAnimationFrame = window[k + "RequestAnimationFrame"], window.cancelAnimationFrame = window[k + "CancelAnimationFrame"] || window[k + "CancelRequestAnimationFrame"]);
        window.requestAnimationFrame || 
        (window.requestAnimationFrame = function(a) {
            var b = (new Date).getTime(), d = Math.max(0, 16 - (b - j)), c = window.setTimeout(function() {
                a(b + d)
            }, d);
            j = b + d;
            return c
        ...
        a._d = 0;
        if (a.st.allowCSS3 && (!e.webkit || a.st.allowCSS3OnWebkit))
            c = g + (g ? "T" : "t"), a._e = c + "ransform" in d && c + "ransition" in d, a._e && (a._f = g + (g ? "P" : "p") + "erspective" in d);
        g = g.toLowerCase();
        a._g = "-" + g + "-";
        ...
        a.staticSlideId = a.currSlideId = 
        a._u = a.st.startSlideId;
        ...
        for (c = 0; c < a.numSlides; c++)
            a.slidesJQ.push(l('<div style="' + 
            (a._l ? "" : c !== a.currSlideId ? a._n : "z-index:0;") + '" class="rsSlide "></div>'));
        a._e1 = d = l(d + "</div></div>");
        g = a.ns;
        ...
        g, a._k1 += " touchmove" + g, a._l1 += " touchend" + g, a._m1 += " touchcancel" + g, a._n1 = 0.5, a.st.sliderTouch && (a._f1 = !0)) : (a.hasTouch = !1, a._n1 = 0.2));
        a.st.sliderDrag && (a._f1 = !0, e.msie || e.opera ? a._g1 = a._h1 = "move" : e.mozilla ? (a._g1 = "-moz-grab", a._h1 = "-moz-grabbing") : e.webkit && -1 != navigator.platform.indexOf("Mac") && (a._g1 = "-webkit-grab", a._h1 = "-webkit-grabbing"), a._i1());
        a.slider.html(d);
        a._o1 = a.st.controlsInside ? a._e1 : a.slider;
        a._p1 = a._e1.children(".rsContainer");
        a.msEnabled && a._p1.css("-ms-touch-action", a._h ? "pan-y" : 
        "pan-x");
        ...
        g[a._g + a._v1] = a.st.css3easeInOut, d.css(g))) : (a._x1 = "left", a._w1 = "top");
        var n;
        ...
        a._p1.click(function(b) {
            if (!a.dragSuccess) {
                ...
                if (-1 !== l.inArray(d, m) && a.toggleVideo())
                    return !1;
    ...
    t.prototype = {constructor: t,_i2: function(b) {
            ...
            var h = this, a, e = {}, d, g = !0;
            b = l(b);
            h._k2 = b;
            h.ev.trigger("rsBeforeParseNode", 
            [b, e]);
            if (!e.stopParsing)
                return b = h._k2, e.id = h._r, e.contentAdded = !1, h._r++, e.images = [], e.isBig = !1, e.hasCover || (b.hasClass("rsImg") ? (d = b, a = !0) : (d = b.find(".rsImg"), d.length && (a = !0)), a ? (e.bigImage = d.eq(0).attr("data-rsBigImg"), d.each(function() {
                    var a = l(this);
            ...
            if (u)
                for (j = m; j < m + q + 1; j++)
                    s = e(j), p = Math.floor((d._u - (m - j)) / d.numSlides) * d.numSlides, (g = d.slides[s]) && c(g, s);
            if (t)
                for (j = m - 1; j > m - 1 - q; j--)
                    s = e(j), p = Math.floor((d._u - (m - j)) / n) * n, (g = d.slides[s]) && c(g, s);
            if (!b) {
                r = e(m - q);
                m = e(m + q);
                q = r > m ? 0 : r;
                for (j = 0; j < n; j++)
                    if (!(r > m && j > r - 1) && (j < q || j > m))
                        if ((g = d.slides[j]) && g.holder)
                            g.holder.detach(), g.isAdded = !1
            }
            ...
            function c() {
                if (b.images) {
                    ...
                    b.isRendered = !0, b.isLoaded = !0, b.isLoading = !1, e(!0)
            }
            function h(c, d) {
                if (c.length) {
                    var e = c[0];
                    if (d !== b.isBig)
                        (e = b.holder.children()) && 1 < e.length && j();
                    else if (b.iW && b.iH)
                        a();
                    else if (b.iW = e.width, b.iH = e.height, b.iW && b.iH)
                        a();
                    else {
                        var f = new Image;
                        f.onload = function() {
            ...
            function e() {
                if (!b.isAppended) {
                    ...
                    if (!f && !b.appendOnLoaded && k.st.fadeinLoadedSlide && (0 === c || (a || k._r2 || k._l2) && (-1 === c || 1 === c)))
                        a = {visibility: "visible",opacity: 0}, a[k._g + "transition"] = "opacity 400ms ease-in-out", b.content.css(a), setTimeout(function() {
            ...
            var k = this;
            b.isLoaded ? e() : f ? !k._l && b.images && b.iW && b.iH ? c() : (b.holder.isWaiting = !0, g(), b.holder.slideId = -99) : c()
        },
        _p2: function(b) {
            ...
            if (c._l2)
                ...
                if (a) {
                    ...
                    if (e && 0 < e.length)
                        h = e[0], 1 < e.length && (c._v2 = !0);
                    else
                        return
                } else
                    b.preventDefault(), h = b, c.msEnabled && (h = h.originalEvent);
                c._l2 = !0;
                c._b.on(c._k1, 
                function(a) {
                    c._x2(a, f)
            ...
            if (this._l3) {
                var c = this._m3, h = b.pageX - this._b3, a = b.pageY - this._c3, e = this._h3 + h, d = this._h3 + a, g = !f ? this._h : this._e3, e = g ? e : d, d = this._z2;
                this._a3 = !0;
                this._b3 = b.pageX;
                this._c3 = b.pageY;
                "x" === d && 0 !== h ? this._f3 = 0 < h ? 1 : -1 : "y" === d && 0 !== 
                a && (this._g3 = 0 < a ? 1 : -1);
                d = g ? this._b3 : this._c3;
                h = g ? h : a;
            ...
            if (!c._s2 || a) {
                if (a) {
                    ...
                    h = b, c.msEnabled && (h = h.originalEvent);
                c._a3 || (c._e && (!f ? c._p1 : c._s3).css(c._g + c._u1, "0s"), function g() {
                    c._l2 && (c._t3 = requestAnimationFrame(g), c._u3 && c._k3(c._u3, f))
                }());
                if (c._l3)
                    b.preventDefault(), c._m3 = (new Date).getTime(), c._u3 = h;
            ...
            function h(b, d) {
                if (a._l || f)
                    g = (-a._u - a._d1) * a._w, j = Math.abs(a._p - g), a._c = j / d, b && (a._c += 250), a._c = c(a._c), a._x3(g, !1)
            }
            var a = this, e, d, g, j;
                    ...
                    if (0 === u || 1 >= r)
                        ...
                        if (f) {
                            ...
                            if (g > a._n3)
                                ...
                                if (g < a._o3) {
                                    a._a4(g, k, !0, a._o3, 200);
                                    return
                                }
                            }
                            a._a4(g, k, !0)
                        } else
                            p + n < m ? 0 > u ? h(!1, d) : a._m2("prev", c(Math.abs(a._p - (-a._u - a._d1 + 1) * a._w) / d), !1, !0, !0) : p - n > m ? 0 < u ? h(!1, d) : a._m2("next", c(Math.abs(a._p - (-a._u - a._d1 - 1) * a._w) / d), !1, !0, !0) : h(!1, d)
                    }
                }
        },_p3: function(b) {
            b = this._p = b;
            ...
            e._r2 && (e._u2(!0), c = !1);
            g = newItemId - e.currSlideId;
            j = e._o2 = e.currSlideId;
            var k = e.currSlideId + g;
            h = e._u;
            var l;
            e._z ? (k = e._n2(!1, k), h += g) : h = k;
            e._o = k;
            ...
            var k = e.st.slidesDiff, m = Boolean(0 < g);
            g = Math.abs(g);
            var p = Math.floor(j / e._y), q = Math.floor((j + (m ? k : -k)) / e._y), p = (m ? Math.max(p, q) : Math.min(p, q)) * e._y + (m ? e._y - 1 : 0);
            ...
            if (g > j + k) {
                ...
                k)) * (m ? -1 : 1);
                f *= 1.4;
                for (j = 0; j < e.numSlides; j++)
                    e.slides[j].positionSet = !1
            }
            e._c = f;
            e._n2(!0);
            a || (l = !0);
            ...
            function e() {
                var a;
                if (g && (a = g.data("rsTimeout")))
                    g !== j && g.css({opacity: 0,display: "none",zIndex: 0}), clearTimeout(a), g.data("rsTimeout", "");
                if (a = j.data("rsTimeout"))
            ...
            k[d._g + d._u1] = d._c + "ms", k[d._g + d._v1] = h ? l.rsCSS3Easing[d.st.easeInOut] : l.rsCSS3Easing[d.st.easeOut], d._p1.css(k), h || !d.hasTouch ? setTimeout(function() {
                d._p3(b)
            }, 5) : d._p3(b)) : (d._c = d.st.transitionSpeed, g = d._h4, j = d._r1, j.data("rsTimeout") && j.css("opacity", 0), e(), g && g.data("rsTimeout", setTimeout(function() {
                k[d._g + d._u1] = "0ms";
                k.zIndex = 0;
                k.display = "none";
                g.data("rsTimeout", "");
            ...
            k[d._g + d._v1] = l.rsCSS3Easing[d.st.easeInOut], j.css(k), j.data("rsTimeout", setTimeout(function() {
                j.css(d._g + d._u1, d._c + "ms");
                j.data("rsTimeout", setTimeout(function() {
                    j.css("opacity", 1);
                    j.data("rsTimeout", "")
                }, 20))
            }, 20))) : d._l ? (k[d._h ? d._x1 : d._w1] = b + "px", d._p1.animate(k, d._c, h ? d.st.easeInOut : d.st.easeOut)) : (g = d._h4, j = d._r1, j.stop(!0, !0).css({opacity: 0,display: "block",zIndex: d._m}), d._c = d.st.transitionSpeed, j.animate({opacity: 1}, d._c, d.st.easeInOut), e(), g && g.data("rsTimeout", setTimeout(function() {
                g.stop(!0, 
            ...
            if (this._l)
                if (this._e) {
                    ...
                    this._p1.stop(!0), this._p = parseInt(this._p1.css(this._x1), 
                    10);
            else
            ...
            if (!b.isRendered) {
                ...
                if (f) {
                    ...
                    if ("none" !== e || a) {
                        ...
                        var j, k, l = {};
                        if ("fit-if-smaller" === e && (g > b || c > d))
                            e = "fit";
                        if ("fill" === e || "fit" === e)
                            j = b / g, k = d / c, j = "fill" == e ? j > k ? j : k : "fit" == e ? j < k ? j : k : 1, g = Math.ceil(g * j, 10), c = Math.ceil(c * j, 10);
                        "none" !== e && (l.width = g, l.height = c, h && f.find(".rsImg").css({width: "100%",height: "100%"}));
                        a && (l.marginLeft = Math.floor((b - g) / 2) + 
...
(function(j) {
    j.extend(j.rsProto, {_q4: function() {
            function k() {
                var e = a.currSlide;
                if (a.currSlide && a.currSlide.isLoaded && a._u4 !== e) {
                    if (0 < a._t4.length) {
                        for (b = 0; b < a._t4.length; b++)
                            clearTimeout(a._t4[b]);
                        a._t4 = []
                    }
                    if (0 < a._s4.length) {
                        var g;
                        for (b = 0; b < a._s4.length; b++)
                            if (g = a._s4[b])
                                a._e ? (g.block.css(a._g + a._u1, "0s"), g.block.css(g.css)) : g.running ? g.block.stop(!0, !0) : g.block.css(g.css), a._u4 = null, e.animBlocksDisplayed = !1;
                        a._s4 = []
                    }
                    e.animBlocks && (e.animBlocksDisplayed = !0, a._u4 = e, a._v4(e.animBlocks))
                }
            }
            var a = this, 
            b;
            a._r4 = {fadeEffect: !0,moveEffect: "top",moveOffset: 20,speed: 400,easing: "easeOutSine",delay: 200};
            ...
            k.each(function(k) {
                ...
                if (0 < f) {
                    ...
                    if (d && "none" !== d) {
                        ...
                        var l, h;
                        isOppositeProp = !1;
                        a._e ? (l = 0, h = a._x1) : (m ? isNaN(parseInt(b.css("right"), 10)) ? h = "left" : (h = "right", isOppositeProp = !0) : isNaN(parseInt(b.css("bottom"), 10)) ? h = "top" : (h = "bottom", isOppositeProp = !0), h = "margin-" + h, isOppositeProp && (f = -f), l = parseInt(b.css(h), 10));
                        g[h] = a._n4("top" === d || "left" === d ? l - f : l + f, m);
                        e[h] = a._n4(l, m)
                    }
                }
                ...
                if (f || d)
                    c = {}, c.hasFade = 
                    Boolean(f), Boolean(d) && (c.moveProp = h, c.hasMove = !0), c.speed = b.data("speed"), isNaN(c.speed) && (c.speed = a.st.block.speed), c.easing = b.data("easing"), c.easing || (c.easing = a.st.block.easing), c.css3Easing = j.rsCSS3Easing[c.easing], c.delay = b.data("delay"), isNaN(c.delay) && (c.delay = a.st.block.delay * k);
                d = {};
                a._e && (d[a._g + a._u1] = "0ms");
                d.moveProp = e.moveProp;
                d.opacity = e.opacity;
                d.display = "none";
                a._s4.push({block: b,css: d});
                a._w4(b, g);
...
(function(f) {
    f.extend(f.rsProto, {_i6: function() {
            ...
            for (var j = 0; j < a.numSlides; j++)
                d = a.slides[j], b += "<div" + g + ' class="rsNavItem rsThumb">' + d.thumbnail + a._p6 + 
                "</div>";
            b = f(b + "</div></div>");
            g = {};
            ...
            if (a._y3 < a._z3)
                a.st.thumbs.autoCenter && a._q3((a._z3 - a._y3) / 2), a.st.thumbs.arrows && a._s6 && (a._s6.addClass("rsThumbsArrowDisabled"), a._t6.addClass("rsThumbsArrowDisabled")), a._m6 = !1, a._n5 = !1, a._l5.off(a._j1);
            else if (a.st.thumbs.navigation && !a._m6 && (a._m6 = !0, !a.hasTouch && a.st.thumbs.drag || 
            a.hasTouch && a.st.thumbs.touch))
                a._n5 = !0, a._l5.on(a._j1, function(b) {
                    a._g2(b, !0)
                });
            a._e && (c[a._g + "transition-duration"] = "0ms");
            a._s3.css(c);
            if (a._w3 && (a.isFullscreen || a.st.thumbs.fitInViewport))
                a._e3 ? a._c4 = a._x6 - a._l5.outerHeight() : a._b4 = a._x6 - a._l5.outerWidth()
